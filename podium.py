...
# --- GLOBAL CSS (Scaled for Projectors) ---
st.markdown("""
<style>
    /* Global Background */
    .stApp {
    ...
    /* TFW Notice Box */
    .tfw-notice { 
        background: linear-gradient(90deg, rgba(3, 105, 161, 0.4) 0%, rgba(3, 105, 161, 0.1) 100%);
...
# --- 2. WELCOME SCREEN ---
    ...
    with right_col:
        ...
        up_content = f"<ul class='card-list'>{''.join([f'<li>{x}</li>' for x in upcoming_evs])}</ul>" if upcoming_evs else "<div style='color:#94a3b8; font-style:italic; font-size:1.5em;'>No upcoming deadlines found.</div>"
...
# --- 3. FOCUS MODE ---
    ...
    <style>
        ...
        ul {{
            font-size: 2em; /* Increased from 1.25em */
            font-weight: 300;
            color: #e2e8f0;
            line-height: 1.6;
            padding-left: 40px;
        ...
        #timer {{
            font-size: 3em; /* Increased from 1.2em */
            font-weight: 400;
            color: #7dd3fc;
            text-align: center;
            margin-top: 60px;
