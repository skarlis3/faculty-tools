...
<style>
    ...
    /* GLASS CARDS (Optimized for Visibility) */
    .glass-card { 
    ...
    .card-list {
        font-size: 4vw; /* INCREASED: Massive Agenda Text */
        font-weight: 300;
        line-height: 1.3;
...
# --- 2. WELCOME SCREEN ---
    ...
    # Changed ratio to 0.8:1.2 to give Agenda maximum horizontal space
    ...
    with col_left:
        ...
        if st.session_state.is_tfw:
            st.markdown(f"<div class='tfw-notice'><strong>TFW Session Today:</strong> Please prepare your journal.</div>", unsafe_allow_html=True)
            ...
            try:
                ...
                if r.status_code == 200:
                    ...
                    for e in events:
                        ...
                        # Upcoming items smaller (2.5vw) than main agenda
